...
const BUILDERS: Record<JobReason, (details: JobDetails) => string> = {
  ...
  CLASSIFICACAO_DIVERGENTE: () =>
    "Esta chave foi registrada com outra classificação de efeito. O que pode ser feito com um pedido que caiu depende inteiramente do que ele toca, e duas chamadas discordando disso não podem compartilhar a mesma chave.",
