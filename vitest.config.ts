...
export default defineConfig({
  test: {
    ...
    testTimeout: 30000,
    // Every suite runs with the network blocked and the installation-wide
    // brake off; see each file for why.
    setupFiles: ["./tests/setup/no-network.ts", "./tests/setup/brake-off.ts"],
    /**
